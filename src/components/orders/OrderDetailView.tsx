  ...
  const generateTransformerUnits = (): TransformerUnit[] => {
    ...
    for (let i = 0; i < Math.min(order.quantity, 10); i++) {
      ...
      units.push({
        ...
        coreTestStatus: statuses[statusIndex].core as any,
        secondaryTestStatus: statuses[statusIndex].secondary as any,
        primaryTestStatus: statuses[statusIndex].primary as any,
        finalTestStatus: statuses[statusIndex].final as any,
        reportStatus: statuses[statusIndex].report as any,
      });
    }
