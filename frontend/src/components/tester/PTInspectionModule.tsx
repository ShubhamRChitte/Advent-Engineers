...
export function PTInspectionModule({ user }: PTInspectionModuleProps) {
        ...
        return (
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <h2 className="text-2xl font-bold text-gray-800">PT Inspection</h2>
                </div>
    ...
    return (
        <div className="space-y-6">
            <div>
                <h2 className="text-2xl font-bold text-gray-800">PT Inspection Module</h2>
                <p className="text-gray-500 mt-1">Select a completed PT transformer to perform the quality inspection report</p>
            </div>
            ...
            {filteredJobIds.length === 0 ? (
                <Card className="p-8 text-center text-gray-500">
                    No completed PT transformers found.
                </Card>
            ) : (
