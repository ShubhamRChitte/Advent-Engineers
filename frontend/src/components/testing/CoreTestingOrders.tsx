...
interface CoreTestingOrdersProps {
  onStartTesting: (order: CoreTestingOrder, coreType: 'Metering' | 'PS' | 'Protection', isReadOnly?: boolean) => void;
  user?: any;
  type?: 'active' | 'history';
}
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-gray-600 font-semibold">{order.clientName}</p>
                    <p className="text-sm text-gray-600 font-semibold">{order.jobId}</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-4 text-sm border-t pt-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 mt-0.5 font-bold text-gray-900">
                ...
                {/* Inline Core Type Selection Cards */}
                <div className="border-t pt-3 mt-3">
                  <CoreTypeSelection
                    order={order}
                    inline={true}
                    onSelectCoreType={(coreType, isReadOnly) => onStartTesting(order, coreType, isReadOnly)}
                    onBack={fetchOrders}
                  />
                </div>
              </div>
