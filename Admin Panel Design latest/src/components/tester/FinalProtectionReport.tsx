...
//   const handleSave = () => {
//     alert('Final Protection Test Report saved successfully!');
//   };
...
//       <div>
//         <h2>Final Test - Protection Core</h2>
...
//           <p className="text-sm">Final Test - Protection Core</p>
//         </div>
...
//           <span className="font-medium">Final Testing - Protection Core</span>
...
export function FinalProtectionReport({
  ...
  try {
    ...
    const payload = {
      ...
      loginType: "final_test_login", // Consistent with your schema path
      tester: testerName,
      coreId: coreId,
    ...
    const response = await axios.post(
      "http://localhost:3002/transformer-final-protection-tests",
      payload,
