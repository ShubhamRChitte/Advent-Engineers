...
export function PTPretestDashboard({ setActiveView, stats, recentActivity, loading }: PTPretestDashboardProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-800">PT Pretesting Dashboard</h2>
