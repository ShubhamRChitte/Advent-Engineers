...
//   const handleSave = () => {
//     alert('PS Test Report saved successfully!');
//   };
...
//       <div>
//         <h2>After Primary Test - PS Core</h2>
...
//           <p className="text-sm">After Primary Test - PS Core</p>
//         </div>
...
//           <span className="font-medium">Pretest After Primary Winding - PS Core</span>
...
export function AfterPrimaryPSReport({ transformer, coreId, testerName, onBack }: any) {
