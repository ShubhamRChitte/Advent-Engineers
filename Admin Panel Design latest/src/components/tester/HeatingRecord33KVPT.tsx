      ...
      <tr className="font-bold text-sm">
        ...
        <td colSpan={3} className="border border-black px-1 py-1 text-center align-middle">
          <Input
            ...
            className={`h-6 text-sm font-bold text-center border-none shadow-none focus-visible:ring-0 bg-transparent w-full p-0 rounded-none ${readOnly ? 'cursor-default' : 'bg-white'}`}
