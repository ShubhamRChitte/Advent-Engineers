...
export interface HeatingRecordBlock {
  ...
  serialNumber: string;  // editable: "11KV – CT = 1", "11KV – CT = 4, 13" etc.
...
interface HeatingRecord11KVCTProps {
  ...
  return (
    <React.Fragment>
      ...
      <tr className="font-bold text-sm">
        ...
        {/* Editable CT label e.g. "11KV – CT = 1", "11KV – CT = 4, 13" */}
...
export function HeatingRecord11KVCT({
  records,
  saving,
  onBack,
  onSave,
