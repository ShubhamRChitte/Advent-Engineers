...
export function SecondaryPSReport({ transformer, coreId, testerName, onBack }: any) {
  ...
  //     stageType: 'secondary_login', // Change this dynamically based on login level
  //     ps_results: psData,
  //     tester: testerName
  //   };
  //   console.log("Saving PS Results:", payload);
  //   toast.success('PS results saved to database!');
  // };
  ...
  try {
    ...
    const response = await axios.post(
      "http://localhost:3002/transformer-secondary-ps-tests",
      payload,
