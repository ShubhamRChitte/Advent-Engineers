...
export function AdminReviewPanel() {
    ...
    const fetchTesters = async () => {
        try {
            const response = await axios.get('http://localhost:5001/auth/testers');
    ...
    const fetchReviewTransformers = async () => {
        setLoading(true);
        try {
            const res = await axios.get('http://localhost:5001/api/transformers/admin-review', {
    ...
    const handleApproveRetest = async (uniqueId: string) => {
        try {
            ...
            const res = await axios.put(`http://localhost:5001/api/transformers/${uniqueId}/approve-retest`,
                { newTester },
                { withCredentials: true }
            );
