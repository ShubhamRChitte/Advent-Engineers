...
export function NotificationsPanel() {
  ...
  const fetchUnreadCount = () => {
    axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5001/api'}/notifications/unread-count`, { withCredentials: true })
      .then(res => setUnreadCount(res.data.count))
      .catch(err => console.error("Error fetching unread count:", err));
  };

  const fetchNotifications = () => {
    axios.get(`${import.meta.env.VITE_API_URL || 'http://localhost:5001/api'}/notifications`, { withCredentials: true })
