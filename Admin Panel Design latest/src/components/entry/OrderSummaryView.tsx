...
<<<<<<< HEAD
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                <div>
                  ...
                  <p className="font-medium">{orderData.transformer.capacity}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Voltage</p>
                  <p className="font-medium">{orderData.transformer.voltageRating}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Phase</p>
                  <p className="font-medium">{orderData.transformer.phase}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-500">Serial Number</p>
                  <p className="font-medium font-mono">{orderData.transformer.serialNumber}</p>
                </div>
                <div>
