...
<<<<<<< HEAD
  const clients: Client[] = [
    {
      id: '1',
      name: 'MSEB Power Distribution Ltd.',
      contactNumber: '+91 98765 43210',
      email: 'contact@mseb.com',
      totalOrders: 12,
      completedOrders: 8,
      inProgressOrders: 4,
    },
