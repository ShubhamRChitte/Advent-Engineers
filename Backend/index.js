...
// Log every request to console for debugging routing issues
app.use((req, res, next) => {
...
// 1. Health Check (Always accessible)
...
app.use('/api/failed-cores', require('./routes/failedCoreRoutes')); // New Failed Core Routes
